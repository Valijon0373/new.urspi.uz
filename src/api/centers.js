...
export const centersAPI = {
    ...
    getLanding: (page = 0, size = 50, lang = 'uz') => request(`/api/landing/centers?page=${page}&size=${size}&lang=${lang}`),
    getLandingById: (id, lang = 'uz') => request(`/api/landing/centers/${id}?lang=${lang}`),
