...
import { Plus, Image as ImageIcon, Check, Trash2, X, Leaf } from 'lucide-react';
...
export default function GreenInstituteAdmin() {
  ...
  const [mockPhotos, setMockPhotos] = useState([
    { id: 1, image: "https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?auto=format&fit=crop&q=80&w=800", title: "Tabiat va biz" },
    { id: 2, image: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80&w=800", title: "Yashil hudud" },
    { id: 3, image: "https://images.unsplash.com/photo-1418065460487-3e41a6c8e1e4?auto=format&fit=crop&q=80&w=800", title: "Eko-aksiya" }
  ]);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 m-0 flex items-center gap-2">
            ...
            Yashil Universitet Hayotidan
          </h2>
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1 m-0">
            Tabiat uyg'unligi aks etgan maxsus lahzalar uchun foto galereya
          </p>
        </div>
        <button
          ...
          <div className="bg-white dark:bg-slate-800 w-full max-w-lg rounded-2xl shadow-xl overflow-hidden flex flex-col">
            ...
            <div className="p-6 space-y-5">
              <div>
                ...
                <input
                  type="text"
                  placeholder="Masalan: Tabiat qo'ynidagi talabalar"
