        ...
        {mockFaculties.map((fac) => (
          <div key={fac.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex items-center gap-3 mt-4 sm:mt-0">
              <button 
                onClick={() => { setSelectedItem(fac); setViewModalOpen(true); }}
              ...
              <button 
                onClick={() => { setSelectedItem(fac); setDeleteModalOpen(true); }}
          ...
          <div className="bg-white dark:bg-slate-800 w-full max-w-lg rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-700">
              <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100 m-0">
                {editMode ? "Fakultetni tahrirlash" : "Fakultet qo'shish"}
              </h3>
              <button
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-5">
              ...
              {(() => {
                const text = {
                  uz: { titleLabel: "Fakultet nomi", titlePl: "Fakultet nomini kiriting", descLabel: "Fakultet haqida qisqacha", descPl: "Fakultet haqida qisqacha ma'lumot kiriting" },
                  ru: { titleLabel: "Название факультета", titlePl: "Введите название факультета", descLabel: "О факультете", descPl: "Введите краткую информацию о факультете" },
                  en: { titleLabel: "Faculty name", titlePl: "Enter faculty name", descLabel: "About faculty", descPl: "Enter short information about the faculty" }
                }[activeLang];
