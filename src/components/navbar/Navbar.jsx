...
const navLinks = [
  {
    ...
    href: '#',
    dropdown: [
      { labelKey: 'navbar.links.history', href: '/infographic' },
      { labelKey: 'navbar.links.charter', href: '#' },
      { labelKey: 'navbar.links.leadership', href: '/leadership' },
      { labelKey: 'navbar.links.faculties', href: '/faculties' },
      { labelKey: 'navbar.links.departments', href: '/departments' },
      { labelKey: 'navbar.links.centers', href: '/centers' },
      { labelKey: 'navbar.links.docs', href: '/regulatory-documents' },
    ],
  },
  {
    ...
    href: '#',
    dropdown: [
      { labelKey: 'navbar.links.council', href: '#' },
      { labelKey: 'navbar.links.finance', href: '#' },
      { labelKey: 'navbar.links.spirituality', href: '#' },
      { labelKey: 'navbar.links.recruitment', href: '#' },
      { labelKey: 'navbar.links.scientific_activity', href: '#' },
    ],
  },
  {
  ...
  },
  {
    ...
    href: '#',
    dropdown: [
      { labelKey: 'navbar.links.bachelor', href: '/bachelor' },
      { labelKey: 'navbar.links.master', href: '/master' },
      { labelKey: 'navbar.links.transfer', href: '#' },
      { labelKey: 'navbar.links.second_specialty', href: '#' },
      { labelKey: 'navbar.links.technicum_graduates', href: '#' },
    ],
  },
