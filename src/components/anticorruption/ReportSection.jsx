                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-1 space-y-6 reveal-on-scroll opacity-0">
                        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-2">{t('anticorruption.hotline_title')}</h3>
                            <p className="text-gray-600 mb-4">{t('anticorruption.hotline_desc')}</p>
                        ...
                        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-2">{t('anticorruption.email_title')}</h3>
                            <p className="text-gray-600 mb-4">{t('anticorruption.email_desc')}</p>
                    ...
                    <div className="lg:col-span-2 bg-white rounded-3xl border border-gray-200 shadow-xl p-8 md:p-10 reveal-on-scroll opacity-0" style={{ animationDelay: '150ms' }}>
                        <h3 className="text-2xl font-bold text-gray-900 mb-6">{t('anticorruption.form_title')}</h3>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2">{t('anticorruption.name_label')}</label>
                                    <input
                                        type="text"
                                        id="name"
                                        value={formData.name}
                                        ...
                                        placeholder={t('anticorruption.name_placeholder')}
                                    />
                                </div>
                                <div>
                                    <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-2">{t('anticorruption.phone_label')}</label>
                                    <input
                                        type="tel"
                                        id="phone"
                                        ...
                                        className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#0c1f4a]/30 focus:border-[#0c1f4a] transition-shadow outline-none"
                                        placeholder={t('anticorruption.phone_placeholder')}
                                    />
                                </div>
                            </div>
                            <div>
                                <label htmlFor="message" className="block text-sm font-medium text-gray-700 mb-2">{t('anticorruption.message_label')} *</label>
                                <textarea
                                    id="message"
                                    required
                                    rows="5"
                                    ...
                                    placeholder={t('anticorruption.message_placeholder')}
                                />
                            </div>
                            <button
                                type="submit"
